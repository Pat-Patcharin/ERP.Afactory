...
export const DELIVERY_ORDERS: DeliveryOrder[] = [
  {
    ...
    history: [
      { t: "Delivered", d: "ผู้รับ: คุณวราภรณ์ ใจดี — รับ 160 จาก 220 หน่วย", u: "Anan P.", when: "01/07/2026 10:45", kind: "primary" },
      { t: "Shipped", d: "ออกจากคลัง 2 กล่อง น้ำหนัก 17.6 กก.", u: "Anan P.", when: "01/07/2026 08:15", kind: "info" },
      { t: "Ready to ship", d: "จัดของขึ้นรถเรียบร้อย", u: "Pimlada P.", when: "30/06/2026 17:40", kind: "info" },
      { t: "Created from PACK2506-0001", d: "สร้างใบส่งของจากงานแพ็ค", u: "Pimlada P.", when: "30/06/2026 17:25", kind: "" },
    ],
    created: "30/06/2026 17:25",
    createdBy: "Pimlada P.",
    updated: "01/07/2026 10:45",
    updatedBy: "Anan P.",
  },
  {
    code: "DO2507-0002",
    ...
    history: [
      { t: "Delivered", d: "ลูกค้ารับของครบ ชำระเงินสด 3,852 บาท", u: "Supavita Y.", when: "03/07/2026 11:20", kind: "primary" },
      { t: "Ready to ship", d: "เตรียมของรอลูกค้ามารับ", u: "Nattapong K.", when: "02/07/2026 10:45", kind: "info" },
      { t: "Created from PACK2506-0002", d: "สร้างใบส่งของจากงานแพ็ค", u: "Nattapong K.", when: "02/07/2026 10:40", kind: "" },
    ],
    created: "02/07/2026 10:40",
    createdBy: "Nattapong K.",
    updated: "03/07/2026 11:20",
  ...
  },
  {
    ...
    history: [
      { t: "Created", d: "ตั้งใบส่งของล่วงหน้ารอของจากฝ่ายแพ็ค", u: "Somchai S.", when: "29/06/2026 12:00", kind: "" },
    ],
    created: "29/06/2026 12:00",
    createdBy: "Somchai S.",
    updated: "29/06/2026 12:00",
    updatedBy: "Somchai S.",
  },
  {
    code: "DO2507-0004",
    ...
    history: [
      { t: "Shipped", d: "ออกจากคลัง มุ่งหน้าคลังบางนา", u: "Somchai B.", when: "04/07/2026 08:05", kind: "info" },
      { t: "Ready to ship", d: "จัดของขึ้นรถ", u: "Pimlada P.", when: "03/07/2026 16:50", kind: "info" },
      { t: "Created from PACK2506-0001", d: "สร้างใบส่งของงวดที่สอง", u: "Pimlada P.", when: "03/07/2026 16:30", kind: "" },
    ],
    created: "03/07/2026 16:30",
    createdBy: "Pimlada P.",
    updated: "04/07/2026 08:05",
    updatedBy: "Somchai B.",
  },
  {
    code: "DO2507-0005",
    ...
    history: [
      { t: "Delivery failed", d: "เหตุผล: ไม่มีผู้รับ — นัดส่งใหม่", u: "Flash Express", when: "02/07/2026 15:30", kind: "warn" },
      { t: "Shipped", d: "ส่งมอบให้ขนส่งแล้ว", u: "Pimlada P.", when: "02/07/2026 09:00", kind: "info" },
      { t: "Created", d: "สร้างใบส่งของ", u: "Somchai S.", when: "01/07/2026 14:20", kind: "" },
    ],
    created: "01/07/2026 14:20",
    createdBy: "Somchai S.",
    updated: "02/07/2026 15:30",
  ...
  },
  {
    ...
    history: [
      { t: "Shipped", d: "ออกจากคลัง 14 หีบห่อ น้ำหนักรวม 486.5 กก.", u: "Teerapat K.", when: "06/07/2026 08:20", kind: "info" },
      { t: "Ready to ship", d: "จัดของขึ้นรถครบ 38 รายการ", u: "Pimlada P.", when: "05/07/2026 17:10", kind: "info" },
      { t: "Created from SO2506-0009", d: "สร้างใบส่งของจากใบสั่งขาย 38 รายการ", u: "Pimlada P.", when: "05/07/2026 16:40", kind: "" },
    ],
    created: "05/07/2026 16:40",
    createdBy: "Pimlada P.",
    updated: "06/07/2026 08:20",
