...
export const PACKING_TASKS: PackingTask[] = [
  {
    ...
    doRef: "DO2507-0001",
    history: [
      { t: "Completed", d: "แพ็คครบ 220 หน่วย เป็น 2 กล่อง", u: "Pimlada P.", when: "30/06/2026 17:25", kind: "primary" },
      { t: "In progress", d: "เริ่มแพ็คสินค้า", u: "Pimlada P.", when: "30/06/2026 16:30", kind: "info" },
      { t: "Created from PK2506-0001", d: "สร้างงานแพ็คจากใบหยิบสินค้า", u: "Warin S.", when: "30/06/2026 16:10", kind: "" },
    ],
    created: "30/06/2026 16:10",
    createdBy: "Warin S.",
    updated: "30/06/2026 17:25",
    updatedBy: "Pimlada P.",
  },
  {
    code: "PACK2506-0002",
    ...
    doRef: "DO2507-0002",
    history: [
      { t: "Completed", d: "แพ็คครบ 36 หน่วย เป็น 1 กล่อง", u: "Nattapong K.", when: "02/07/2026 10:40", kind: "primary" },
      { t: "Created from PK2506-0003", d: "สร้างงานแพ็คจากใบหยิบสินค้า", u: "Nattapong K.", when: "02/07/2026 10:05", kind: "" },
    ],
    created: "02/07/2026 10:05",
    createdBy: "Nattapong K.",
    updated: "02/07/2026 10:40",
  ...
  },
  {
    ...
    doRef: "",
    history: [
      { t: "Created from PK2506-0002", d: "สร้างงานแพ็ครอไว้ ยังหยิบไม่ครบ", u: "Warin S.", when: "29/06/2026 11:45", kind: "" },
    ],
    created: "29/06/2026 11:45",
    createdBy: "Warin S.",
    updated: "29/06/2026 11:45",
    updatedBy: "Warin S.",
  },
];
