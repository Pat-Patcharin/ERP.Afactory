...
export const USERS: UserDef[] = [
  ...
  },
  {
    ...
    salesRep: "",
    status: "Active",
    lastLogin: "10/08/2026 08:40",
    created: "10/08/2026",
    createdBy: "System",
    team: "Sales Support",
    phone: "081-401-1006",
    note: "อนุมัติใบเสนอราคาราคาปกติ และยืนยันลูกค้าใหม่ที่ผู้แทนขายเปิดไว้",
  },
  {
    code: "EMP020",
    username: "noey",
    name: "Noey",
    email: "noey@afactory.co.th",
    department: "Sales",
    roleCode: "SALES_REP",
    scope: "ownCustomers",
    warehouse: "",
    salesRep: "",
    status: "Active",
    lastLogin: "10/08/2026 08:15",
    created: "10/08/2026",
    createdBy: "System",
    team: "Sales Support",
    phone: "081-401-1007",
    note: "เปิดใบเสนอราคาและเพิ่มลูกค้าใหม่ — อนุมัติเองไม่ได้",
  },
];
...
export const NUMBER_SERIES: SeriesDef[] = [
  ...
  { code: "NS-SHP", module: "shipment", label: "Shipment", prefix: "SHP", yearMode: "AD", yearDigits: 4, separatorAfterPrefix: true, useMonth: false, padding: 6, next: 46, resetCycle: "Yearly", separator: "-", status: "Active", lastIssued: "SHP-2026-000045", updated: "01/08/2026 10:15", updatedBy: "System" },
  { code: "NS-RTN", module: "sales-return", label: "Sales Return", prefix: "RTN", yearMode: "AD", yearDigits: 4, separatorAfterPrefix: true, useMonth: false, padding: 6, next: 21, resetCycle: "Yearly", separator: "-", status: "Active", lastIssued: "RTN-2026-000020", updated: "22/07/2026 09:00", updatedBy: "System" },
  { code: "NS-CN", module: "credit-note", label: "Credit Note", prefix: "CN", yearMode: "AD", yearDigits: 4, separatorAfterPrefix: true, useMonth: false, padding: 6, next: 23, resetCycle: "Yearly", separator: "-", status: "Active", lastIssued: "CN-2026-000022", updated: "30/05/2026 16:20", updatedBy: "System" },
  { code: "NS-TRF", module: "stock-transfer", label: "Stock Transfer", prefix: "TRF", yearMode: "AD", yearDigits: 4, separatorAfterPrefix: true, useMonth: false, padding: 6, next: 46, resetCycle: "Yearly", separator: "-", status: "Active", lastIssued: "TRF-2026-000045", updated: "23/07/2026 13:00", updatedBy: "System" },
  { code: "NS-ADJ", module: "stock-adjustment", label: "Stock Adjustment", prefix: "ADJ", yearMode: "AD", yearDigits: 4, separatorAfterPrefix: true, useMonth: false, padding: 6, next: 46, resetCycle: "Yearly", separator: "-", status: "Active", lastIssued: "ADJ-2026-000045", updated: "11/06/2026 10:00", updatedBy: "System" },
  { code: "NS-CNT", module: "cycle-count", label: "Cycle Count", prefix: "CNT", yearMode: "AD", yearDigits: 4, separatorAfterPrefix: true, useMonth: false, padding: 6, next: 46, resetCycle: "Yearly", separator: "-", status: "Active", lastIssued: "CNT-2026-000045", updated: "22/06/2026 15:00", updatedBy: "System" },
  { code: "NS-BP", module: "business-partner", label: "Business Partner", prefix: "BP", yearMode: "None", yearDigits: 0, separatorAfterPrefix: false, useMonth: false, padding: 6, next: 124, resetCycle: "Never", separator: "", status: "Active", lastIssued: "BP000123", updated: "22/07/2026 11:20", updatedBy: "System" },
];
...
export const COMPANY = {
  ...
  whtRate: 3,
  /**
   * เพดานงบโปรโมชั่นที่แอดมินอนุมัติได้เอง เกินกว่านี้ต้องขึ้นผู้จัดการ
   *
   * ย้ายมาจาก lib/domain/promotion.ts เพราะเป็นค่าตั้งระบบ ไม่ใช่ตรรกะของ
   * โมดูล — อยู่รวมกับอัตราภาษีและรอบปีบัญชีที่คนคนเดียวกันเป็นคนตั้ง
   *
   * 200,000 เป็นตัวเลขชั่วคราว ยังไม่ได้ตัดสิน (§7 ข้อ 4) — รอตัวเลขจริง
   * จากผู้บริหาร อย่าเดาตัวเลขใหม่กระจายไว้หลายที่
   */
  promotionManagerBudgetCeiling: 200_000,
...
export const AUDIT_LOG: AuditEntry[] = [
  { code: "LOG-000120", when: "03/08/2026 09:05", event: "Login", user: "ณัฐพล วงศ์ดี", userCode: "EMP005", role: "Purchase Manager", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.1.24", result: "Success" },
  { code: "LOG-000119", when: "03/08/2026 08:58", event: "Approve", user: "ณัฐพล วงศ์ดี", userCode: "EMP005", role: "Purchase Manager", module: "purchase-request", ref: "PR2506-0124", detail: "อนุมัติขั้นที่ 1 — 20,550 THB", ip: "10.0.1.24", result: "Success" },
  { code: "LOG-000118", when: "03/08/2026 08:42", event: "Login", user: "พิมพกา สุขใจ", userCode: "EMP001", role: "Super Admin", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.1.10", result: "Success" },
  { code: "LOG-000117", when: "03/08/2026 08:31", event: "Login Failed", user: "chidtima.k", userCode: "EMP011", role: "Sales Representative", module: "—", ref: "", detail: "รหัสผ่านไม่ถูกต้อง (ครั้งที่ 3)", ip: "203.150.11.8", result: "Failed" },
  { code: "LOG-000116", when: "03/08/2026 08:15", event: "Login", user: "วิรัตน์ ตั้งมั่น", userCode: "EMP008", role: "Warehouse Staff", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.2.31", result: "Success" },
  { code: "LOG-000115", when: "03/08/2026 08:02", event: "Update", user: "วิรัตน์ ตั้งมั่น", userCode: "EMP008", role: "Warehouse Staff", module: "put-away", ref: "PA25060004", detail: "อัปเดตสถานะเป็น In Progress", ip: "10.0.2.31", result: "Success" },
  { code: "LOG-000114", when: "03/08/2026 07:55", event: "Login", user: "สมศักดิ์ กิจเจริญ", userCode: "EMP002", role: "Management", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "58.11.20.7", result: "Success" },
  { code: "LOG-000113", when: "02/08/2026 18:40", event: "Export", user: "กานดา ประเสริฐ", userCode: "EMP007", role: "Finance Manager", module: "sales-invoice", ref: "", detail: "ส่งออกใบแจ้งหนี้ 16 รายการ เป็น Excel", ip: "10.0.3.12", result: "Success" },
  { code: "LOG-000112", when: "02/08/2026 17:22", event: "Permission Change", user: "พิมพกา สุขใจ", userCode: "EMP001", role: "Super Admin", module: "admin-role", ref: "QC_INSPECTOR", detail: "เพิ่มสิทธิ์ approve ใน QC Inspection", ip: "10.0.1.10", result: "Success" },
  { code: "LOG-000111", when: "02/08/2026 17:20", event: "Login", user: "สมชาย ใจดี", userCode: "EMP003", role: "Sales Manager", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.4.5", result: "Success" },
  { code: "LOG-000110", when: "02/08/2026 16:45", event: "Create", user: "สุภาวิตา โยธะพันธ์", userCode: "EMP004", role: "Sales Representative", module: "sales-order", ref: "SO2507-0005", detail: "สร้างใบสั่งขาย 12,900 THB", ip: "10.0.4.9", result: "Success" },
  { code: "LOG-000109", when: "02/08/2026 16:10", event: "Login", user: "สุภาวิตา โยธะพันธ์", userCode: "EMP004", role: "Sales Representative", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.4.9", result: "Success" },
  { code: "LOG-000108", when: "02/08/2026 15:02", event: "Reject", user: "กานดา ประเสริฐ", userCode: "EMP007", role: "Finance Manager", module: "credit-note", ref: "CN-2026-000022", detail: "ปฏิเสธ — เอกสารอ้างอิงไม่ครบ", ip: "10.0.3.12", result: "Success" },
  { code: "LOG-000107", when: "02/08/2026 11:00", event: "Login", user: "ธนพล ศรีสุข", userCode: "EMP010", role: "QC Inspector", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.5.2", result: "Success" },
  { code: "LOG-000106", when: "02/08/2026 10:48", event: "Update", user: "ธนพล ศรีสุข", userCode: "EMP010", role: "QC Inspector", module: "qc-inspection", ref: "QC2506-0008", detail: "บันทึกผลตรวจ Pass 480 / Fail 20", ip: "10.0.5.2", result: "Success" },
  { code: "LOG-000105", when: "02/08/2026 09:30", event: "Print", user: "วิรัตน์ ตั้งมั่น", userCode: "EMP008", role: "Warehouse Staff", module: "picking", ref: "PK2507-0003", detail: "พิมพ์ใบจัดของ", ip: "10.0.2.31", result: "Success" },
  { code: "LOG-000104", when: "01/08/2026 15:30", event: "Login", user: "อาริสา มณีวงศ์", userCode: "EMP009", role: "Purchasing Staff", module: "—", ref: "", detail: "เข้าสู่ระบบสำเร็จ", ip: "10.0.1.44", result: "Success" },
  { code: "LOG-000103", when: "01/08/2026 15:12", event: "Import", user: "พิมพกา สุขใจ", userCode: "EMP001", role: "Super Admin", module: "business-partner", ref: "", detail: "นำเข้าคู่ค้า 30 รายการจาก Excel", ip: "10.0.1.10", result: "Success" },
  { code: "LOG-000102", when: "01/08/2026 10:15", event: "Create", user: "ปิยนารถ เจริญทอง", userCode: "EMP006", role: "Warehouse Manager", module: "shipment", ref: "SHP-2026-000045", detail: "สร้างใบจัดส่ง", ip: "10.0.2.8", result: "Success" },
  { code: "LOG-000101", when: "31/07/2026 17:50", event: "Logout", user: "สมชาย ใจดี", userCode: "EMP003", role: "Sales Manager", module: "—", ref: "", detail: "ออกจากระบบ", ip: "10.0.4.5", result: "Success" },
];
...
export const ADMIN_PLACEHOLDERS = {
  apiKeys: 0,
  backups: { last: "02/08/2026 23:00", size: "412 MB", retention: "30 วัน" },
