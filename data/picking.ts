...
export const PICKING_TASKS: PickingTask[] = [
  {
    ...
    history: [
      { t: "Completed", d: "หยิบครบ 220 หน่วย ส่งต่อฝ่ายแพ็ค", u: "Warin S.", when: "30/06/2026 16:10", kind: "primary" },
      { t: "In progress", d: "เริ่มหยิบสินค้า", u: "Warin S.", when: "30/06/2026 14:30", kind: "info" },
      { t: "Assigned", d: "มอบหมายให้ Warin S.", u: "Somchai B.", when: "30/06/2026 09:00", kind: "info" },
      { t: "Created from SO2506-0001", d: "สร้างใบหยิบสินค้าจากใบสั่งขาย", u: "Patcharin T.", when: "29/06/2026 17:00", kind: "" },
    ],
    created: "29/06/2026 17:00",
    createdBy: "Patcharin T.",
    updated: "30/06/2026 16:10",
    updatedBy: "Warin S.",
  },
  {
    code: "PK2506-0002",
    ...
    packRef: "",
    history: [
      { t: "Short pick recorded", d: "AA-TH003-WL หยิบได้ 180 จาก 240", u: "Warin S.", when: "29/06/2026 11:40", kind: "warn" },
      { t: "In progress", d: "เริ่มหยิบสินค้า", u: "Warin S.", when: "29/06/2026 09:20", kind: "info" },
      { t: "Assigned", d: "มอบหมายให้ Warin S.", u: "Somchai B.", when: "29/06/2026 09:00", kind: "info" },
      { t: "Created from SO2506-0002", d: "สร้างใบหยิบสินค้าจากใบสั่งขาย", u: "Somchai S.", when: "28/06/2026 10:00", kind: "" },
    ],
    created: "28/06/2026 10:00",
    createdBy: "Somchai S.",
    updated: "29/06/2026 11:40",
    updatedBy: "Warin S.",
  },
  {
    code: "PK2506-0003",
    ...
    history: [
      { t: "Completed", d: "หยิบครบ 36 หน่วย", u: "Nattapong K.", when: "02/07/2026 10:05", kind: "primary" },
      { t: "Assigned", d: "มอบหมายให้ Nattapong K.", u: "Supavita Y.", when: "02/07/2026 09:10", kind: "info" },
      { t: "Created from SO2506-0004", d: "สร้างใบหยิบสินค้าจากใบสั่งขาย", u: "Supavita Y.", when: "01/07/2026 08:30", kind: "" },
    ],
    created: "01/07/2026 08:30",
    createdBy: "Supavita Y.",
    updated: "02/07/2026 10:05",
  ...
  },
  {
    ...
    packRef: "",
    history: [
      { t: "Created from SO2506-0005", d: "สร้างใบหยิบสินค้าจากใบสั่งขาย รอมอบหมาย", u: "Somchai S.", when: "01/07/2026 09:20", kind: "" },
    ],
    created: "01/07/2026 09:20",
    createdBy: "Somchai S.",
    updated: "01/07/2026 09:20",
    updatedBy: "Somchai S.",
  },
];
