...
export const SALES_ORDERS: SalesOrder[] = [
  {
    ...
    history: [
      { t: "Partially delivered", d: "ส่งมอบงวดแรก 160 หน่วย", u: "Somchai B.", when: "01/07/2026 10:45", kind: "info" },
      { t: "Picking completed", d: "หยิบสินค้าครบตามใบสั่งขาย", u: "Warin S.", when: "30/06/2026 16:10", kind: "info" },
      { t: "Confirmed", d: "ยืนยันคำสั่งขาย เครดิตผ่าน", u: "Patcharin T.", when: "25/06/2026 10:30", kind: "primary" },
      { t: "Created from SR2506-0001", d: "แปลงจากใบขอเสนอราคา", u: "Patcharin T.", when: "25/06/2026 10:12", kind: "" },
    ],
  ...
  },
  {
    ...
    history: [
      { t: "Picking started", d: "มอบหมายงานหยิบสินค้าให้ Warin S.", u: "Warin S.", when: "29/06/2026 09:20", kind: "info" },
      { t: "Confirmed", d: "ยืนยันคำสั่งขาย", u: "Somchai S.", when: "28/06/2026 09:30", kind: "primary" },
      { t: "Created from SR2506-0003", d: "แปลงจากใบขอเสนอราคา", u: "Somchai S.", when: "28/06/2026 09:20", kind: "" },
    ],
    created: "28/06/2026 09:20",
    createdBy: "Somchai S.",
    updated: "29/06/2026 09:20",
    updatedBy: "Warin S.",
  },
  {
    code: "SO2506-0003",
    ...
    history: [
      { t: "Put on credit hold", d: "ยอดรวมเกินวงเงินเครดิตคงเหลือ", u: "ระบบ", when: "29/06/2026 14:05", kind: "warn" },
      { t: "Created", d: "สร้างใบสั่งขายจากใบสั่งซื้อของโรงพยาบาล", u: "Narin C.", when: "29/06/2026 14:00", kind: "" },
    ],
    created: "29/06/2026 14:00",
    createdBy: "Narin C.",
    updated: "29/06/2026 14:05",
    updatedBy: "ระบบ",
  },
  {
    code: "SO2506-0004",
    ...
    history: [
      { t: "Completed", d: "ส่งมอบครบถ้วน ลูกค้ารับของแล้ว", u: "Supavita Y.", when: "03/07/2026 11:20", kind: "primary" },
      { t: "Confirmed", d: "ยืนยันคำสั่งขาย ชำระเงินสด", u: "Supavita Y.", when: "30/06/2026 16:00", kind: "primary" },
      { t: "Created", d: "สร้างใบสั่งขาย", u: "Supavita Y.", when: "30/06/2026 15:45", kind: "" },
    ],
    created: "30/06/2026 15:45",
  ...
  },
  {
    ...
    history: [
      { t: "Confirmed", d: "ยืนยันคำสั่งขาย รอจัดของ", u: "Somchai S.", when: "01/07/2026 09:15", kind: "primary" },
      { t: "Created from QT2507-0007", d: "แปลงจากใบเสนอราคา", u: "Somchai S.", when: "01/07/2026 09:05", kind: "primary" },
    ],
    created: "01/07/2026 09:05",
    createdBy: "Somchai S.",
    updated: "01/07/2026 09:15",
    updatedBy: "Somchai S.",
  },
  {
    ...
    history: [
      { t: "Partially Delivered", d: "ส่งงวดแรกตาม DO2507-0006", u: "Pimlada P.", when: "06/07/2026 09:30", kind: "info" },
      { t: "Confirmed", d: "ยืนยันคำสั่งขาย 38 รายการ", u: "Patcharin T.", when: "26/06/2026 14:20", kind: "primary" },
      { t: "Created", d: "สร้างใบสั่งขายจากใบสั่งซื้อของลูกค้า", u: "Patcharin T.", when: "26/06/2026 13:55", kind: "" },
    ],
    created: "26/06/2026 13:55",
    createdBy: "Patcharin T.",
    updated: "06/07/2026 09:30",
    updatedBy: "Pimlada P.",
  },
];
